...
Route::get('/TermsOfUsage', [TermController::class, 'index'])->name('TermsOfUsage');

Route::get('/ComingSoon', [ComingSoonController::class, 'index'])->name('ComingSoon');

Route::get('/PrivacyAndPolices', [PrivacyPoliciesController::class, 'index'])->name('PrivacyAndPolices');
